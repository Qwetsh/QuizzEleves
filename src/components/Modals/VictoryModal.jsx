...
export default function VictoryModal() {
  ...
  // Reset dismissed when a new game finishes
  ...
  if (!finished || dismissed || !winner) return null;
  ...
  return (
    <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
      ...
      <div
        className="modal-pop relative z-50 bg-gradient-to-b from-yellow-50 via-white to-yellow-50 rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden"
