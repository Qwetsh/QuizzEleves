...
export const GEO_PLACES = [
  { name: 'La tour Eiffel (Paris)', lat: 48.86, lon: 2.29 },
  { name: 'Le Mont-Saint-Michel', lat: 48.64, lon: -1.51 },
  { name: 'La statue de la Liberté (New York)', lat: 40.69, lon: -74.04 },
  { name: 'Le Machu Picchu (Pérou)', lat: -13.16, lon: -72.54 },
  { name: 'Les pyramides de Gizeh (Égypte)', lat: 29.98, lon: 31.13 },
  { name: 'La Grande Muraille de Chine', lat: 40.36, lon: 115.99 },
  { name: 'Le Taj Mahal (Inde)', lat: 27.17, lon: 78.04 },
  { name: "L'opéra de Sydney (Australie)", lat: -33.86, lon: 151.21 },
  { name: 'Le mont Fuji (Japon)', lat: 35.36, lon: 138.73 },
  { name: 'Le Kilimandjaro (Tanzanie)', lat: -3.07, lon: 37.35 },
  { name: 'Le Christ Rédempteur (Rio de Janeiro)', lat: -22.95, lon: -43.21 },
  { name: 'Le Colisée (Rome)', lat: 41.89, lon: 12.49 },
  { name: "L'Acropole (Athènes)", lat: 37.97, lon: 23.73 },
  { name: 'Big Ben (Londres)', lat: 51.50, lon: -0.12 },
  { name: 'Le Kremlin (Moscou)', lat: 55.75, lon: 37.62 },
  { name: 'La Sagrada Família (Barcelone)', lat: 41.40, lon: 2.17 },
  { name: 'Les chutes du Niagara', lat: 43.08, lon: -79.07 },
  { name: 'Le Grand Canyon (États-Unis)', lat: 36.10, lon: -112.10 },
  { name: "L'Everest (Himalaya)", lat: 27.99, lon: 86.93 },
  { name: 'Pétra (Jordanie)', lat: 30.33, lon: 35.44 },
  { name: 'Angkor Vat (Cambodge)', lat: 13.41, lon: 103.87 },
  { name: "Les moaï de l'île de Pâques", lat: -27.13, lon: -109.35 },
  { name: 'Chichén Itzá (Mexique)', lat: 20.68, lon: -88.57 },
  { name: 'Burj Khalifa (Dubaï)', lat: 25.20, lon: 55.27 },
  { name: "La forêt amazonienne (Manaus)", lat: -3.10, lon: -60.00 },
  { name: 'Le Golden Gate (San Francisco)', lat: 37.82, lon: -122.48 },
  { name: 'Sainte-Sophie (Istanbul)', lat: 41.01, lon: 28.98 },
  { name: 'La montagne de la Table (Le Cap)', lat: -33.96, lon: 18.40 },
  { name: 'Les chutes Victoria (Zambèze)', lat: -17.92, lon: 25.86 },
  { name: 'Uluru (Australie)', lat: -25.34, lon: 131.04 },
  { name: 'Les geysers de Geysir (Islande)', lat: 64.31, lon: -20.30 },
  { name: 'Le lac Baïkal (Sibérie)', lat: 53.50, lon: 108.00 },
  { name: 'Le Cervin / Matterhorn (Alpes)', lat: 45.98, lon: 7.66 },
  { name: 'Stonehenge (Angleterre)', lat: 51.18, lon: -1.83 },
  { name: 'Le cap Horn (Chili)', lat: -55.98, lon: -67.27 },
  { name: "L'allée des baobabs (Madagascar)", lat: -20.25, lon: 44.42 },
  { name: 'Le parc de Yellowstone (États-Unis)', lat: 44.60, lon: -110.50 },
  { name: 'Le volcan Kīlauea (Hawaï)', lat: 19.41, lon: -155.28 },
  { name: 'La porte de Brandebourg (Berlin)', lat: 52.52, lon: 13.38 },
  { name: 'Venise (Italie)', lat: 45.43, lon: 12.34 },
];
