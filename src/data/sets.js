...
export const SETS = {
  nature: {
    name: 'Tenue de la Nature', name_en: 'Nature Garb', icon: '🌿', color: '#779313',
  ...
  marchand: {
    name: 'Panoplie du Marchand', name_en: "Merchant's Set", icon: '💰', color: '#c79120',
  ...
  explorateur: {
    name: "Set de l'Explorateur", name_en: "Explorer's Set", icon: '🧭', color: '#579b9a',
  ...
  sage: {
    name: 'Habit du Sage', name_en: "Sage's Attire", icon: '🦉', color: '#3160a5',
  ...
  duelliste: {
    name: 'Armure du Duelliste', name_en: "Duelist's Armor", icon: '⚔️', color: '#8a1f2e',
