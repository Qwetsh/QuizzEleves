export const EVENTS = {
  ...
  foudreFree:   { name: 'Foudre gratuite',   icon: '\u26A1',     desc: 'Choisis une equipe : elle recule de 3 cases.',                                  optional: true,  weight: 1 },
  ...
  quitteDouble: { name: 'Quitte ou double',  icon: '\u{1F3B0}',  desc: 'Lance le de. Si 4-6 : avance du DOUBLE. Si 1-3 : recule de ce nombre.',        optional: true,  weight: 1 },
  pari:         { name: 'Pari',              icon: '\u{1F4B0}',  desc: 'Reponds a une question. Reussi : +3 cases. Rate : -3 cases.',                   optional: true,  weight: 1 },
  recharge:     { name: 'Recharge',          icon: '\u{1F50B}',  desc: 'Gagne 1 charge de Bouclier OU 1 charge d\'Indice (a choisir).',                 optional: false, weight: 1 },
  vol:          { name: 'Vol',               icon: '\u{1FA99}',  desc: 'Choisis un adversaire et prends 1 de ses charges (Bouclier ou Indice).',        optional: true,  weight: 1 },
