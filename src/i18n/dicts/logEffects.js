...
export default {
  ...
  'log.fx.askFlag':            { fr: '🚩 {who} sera un drapeau à identifier !', en: '🚩 {who} will be a flag to identify!' },
  'log.fx.askFlag.toast':      { fr: '🚩 Question drapeau !', en: '🚩 Flag question!' },
  ...
  'log.fx.swap':         { fr: '🔀 {aemoji} {aname} échange sa place avec {bemoji} {bname} !', en: '🔀 {aemoji} {aname} swaps places with {bemoji} {bname}!' },
  'log.fx.anchor':       { fr: '⚓ {emoji} {name} est ancré : déplacement forcé annulé !', en: '⚓ {emoji} {name} is anchored: forced movement cancelled!' },
  'log.fx.insurance':    { fr: '🛟 Assurance : {emoji} {name} récupère {n} 🪙.', en: '🛟 Insurance: {emoji} {name} recovers {n} 🪙.' },
  'log.fx.stealCharge':      { fr: '⚡ {aemoji} {aname} vole une charge de pouvoir à {vemoji} {vname} !', en: '⚡ {aemoji} {aname} steals a power charge from {vemoji} {vname}!' },
  'log.fx.stealChargeDrain': { fr: '⚡ {aemoji} {aname} draine une charge de {vemoji} {vname} (aucun pouvoir à recharger).', en: '⚡ {aemoji} {aname} drains a charge from {vemoji} {vname} (no power to refill).' },
  'log.fx.stealChargeNone':  { fr: '⚡ {emoji} {name} n’a aucune charge à voler.', en: '⚡ {emoji} {name} has no charge to steal.' },
  'log.fx.bounty':       { fr: '🎯 Prime de {n} 🪙 posée : la prochaine erreur de la cible la fera tomber.', en: '🎯 {n} 🪙 bounty placed: the target’s next mistake pays out.' },
  'log.fx.bounty.toast': { fr: '🎯 Prime de {n} 🪙 !', en: '🎯 {n} 🪙 bounty!' },
  'log.fx.invest':       { fr: '📈 {emoji} {name} investit {stake} 🪙 ({rate} % à la prochaine bonne réponse).', en: '📈 {emoji} {name} invests {stake} 🪙 ({rate}% on next correct answer).' },
  'log.fx.invest.toast': { fr: '📈 Investi {stake} 🪙 ({rate} %)', en: '📈 Invested {stake} 🪙 ({rate}%)' },
  'log.fx.investNoGold': { fr: '📈 {emoji} {name} n’a pas assez d’or pour investir.', en: '📈 {emoji} {name} lacks the gold to invest.' },
  'log.fx.checkpoint':       { fr: '🚩 {emoji} {name} pose un point de contrôle ici.', en: '🚩 {emoji} {name} sets a checkpoint here.' },
  'log.fx.checkpoint.toast': { fr: '🚩 Point de contrôle posé', en: '🚩 Checkpoint set' },
  'log.fx.swap.toast':   { fr: '🔀 {aname} ↔ {bname}', en: '🔀 {aname} ↔ {bname}' },
  'log.fx.thorns':       { fr: '🌵 Épines de {vemoji} {vname} : {aemoji} {aname} perd {n} 🪙 en retour !', en: '🌵 {vemoji} {vname}’s thorns: {aemoji} {aname} loses {n} 🪙 in return!' },
  'log.fx.thornsRecul':  { fr: ['🌵 Épines : {emoji} {name} recule de {n} case en retour !', '🌵 Épines : {emoji} {name} recule de {n} cases en retour !'],
                           en: ['🌵 Thorns: {emoji} {name} is pushed back {n} square in return!', '🌵 Thorns: {emoji} {name} is pushed back {n} squares in return!'] },
