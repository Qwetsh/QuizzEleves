...
export default {
  ...
  'fight.timeline.exhaustWin': { fr: 'Paquet épuisé — {team} l\'emporte à la précision !', en: 'Deck exhausted — {team} wins on precision!' },
  'fight.timeline.reshuffled': { fr: 'Paquet re-brassé !', en: 'Deck reshuffled!' },
  ...
  // Skyrim / Bordeciel (Curioscope, carte parchemin) — « où se trouve ce lieu ? ».
  'fight.mg.skyrim.name': { fr: 'Cartographe de Bordeciel', en: 'Skyrim Cartographer' },
  'fight.mg.skyrim.rules': { fr: "Où se trouve ce lieu de Bordeciel ? Un lieu est nommé : chaque équipe plante son repère à l'endroit qu'elle croit être le bon sur la carte de Skyrim. Le plus proche marque le plus de points !", en: 'Where is this place in Skyrim? A location is named: each team plants its marker where they think it belongs on the map of Skyrim. Closest guess scores the most points!' },
  'fight.mg.skyrim.goal': { fr: 'Retrouve le lieu de Bordeciel et place ton repère au plus près !', en: 'Find the place in Skyrim and pin it as close as you can!' },
  'fight.mg.skyrim.step1': { fr: 'Lis le nom du lieu de Bordeciel à trouver', en: 'Read the name of the Skyrim place to find' },
  'fight.mg.skyrim.step2': { fr: 'Explore la carte, zoome et pose ton repère', en: 'Explore the map, zoom in and place your marker' },
  'fight.mg.skyrim.step3': { fr: 'Valide — révélation quand les deux équipes ont joué', en: 'Confirm — reveal once both teams have played' },
  'fight.mg.skyrim.step4': { fr: 'Points selon la distance : le plus précis gagne !', en: 'Points by distance: the most precise wins!' },
  ...
  // --- Duel de sorts (rythme, façon Guitar Hero, thème harrypotter) ---
  'fight.mg.wizard.name': { fr: 'Duel de sorts', en: 'Spell Duel' },
  'fight.mg.wizard.rules': { fr: 'Des scènes cultes des films et des livres tombent en rythme ; en bas, une main de 4 sorts. Tapez le BON sort au BON moment, pile sur la ligne ! Bon sort + bon timing = points, et les combos font grimper le multiplicateur. Les deux équipes jouent la même partition en même temps : le meilleur score l\'emporte.', en: 'Iconic scenes from the films and books fall to the beat; at the bottom, a hand of 4 spells. Tap the RIGHT spell at the RIGHT moment, dead on the line! Right spell + right timing = points, and combos ramp up your multiplier. Both teams play the same chart at once: best score wins.' },
  'fight.mg.wizard.goal': { fr: 'Tapez le bon sort au bon moment — enchaînez les combos !', en: 'Tap the right spell on beat — chain your combos!' },
  'fight.mg.wizard.winLabel': { fr: 'Meilleur score à la fin de la partition', en: 'Best score at the end of the chart' },
  'fight.mg.wizard.step1': { fr: 'Un événement du lore tombe vers la ligne de tir', en: 'A lore event falls toward the hit line' },
  'fight.mg.wizard.step2': { fr: 'Tapez le sort qui lui correspond, pile quand il franchit la ligne', en: 'Tap the matching spell, right as it crosses the line' },
  'fight.mg.wizard.step3': { fr: 'Bon sort + bon timing = combo ; le meilleur score gagne le duel', en: 'Right spell + right timing = combo; best score wins the duel' },
  'fight.wizard.hint': { fr: 'Tapez le bon sort quand l\'événement franchit la ligne !', en: 'Tap the right spell as the event crosses the line!' },
  'fight.wizard.phonesHint': { fr: 'Jouez sur vos appareils !', en: 'Play on your devices!' },
  'fight.wizard.youWin': { fr: 'Tu l\'emportes !', en: 'You win!' },
  'fight.wizard.youLose': { fr: 'Battu…', en: 'Beaten…' },
  ...
  // Types Gén. 1 (badges draft + sous-titres d'attaque).
  'fight.pkmn.type.normal': { fr: 'Normal', en: 'Normal' },
  'fight.pkmn.type.fire': { fr: 'Feu', en: 'Fire' },
  'fight.pkmn.type.water': { fr: 'Eau', en: 'Water' },
  'fight.pkmn.type.grass': { fr: 'Plante', en: 'Grass' },
  'fight.pkmn.type.electric': { fr: 'Élec', en: 'Electric' },
  'fight.pkmn.type.ice': { fr: 'Glace', en: 'Ice' },
  'fight.pkmn.type.fighting': { fr: 'Combat', en: 'Fighting' },
  'fight.pkmn.type.poison': { fr: 'Poison', en: 'Poison' },
  'fight.pkmn.type.ground': { fr: 'Sol', en: 'Ground' },
  'fight.pkmn.type.rock': { fr: 'Roche', en: 'Rock' },
  'fight.pkmn.type.flying': { fr: 'Vol', en: 'Flying' },
  'fight.pkmn.type.psychic': { fr: 'Psy', en: 'Psychic' },
  'fight.pkmn.type.bug': { fr: 'Insecte', en: 'Bug' },
  'fight.pkmn.type.ghost': { fr: 'Spectre', en: 'Ghost' },
  'fight.pkmn.type.dragon': { fr: 'Dragon', en: 'Dragon' },
  // Stats : nom complet (dialogues) + abrégé (badges de boost sur la scène).
  'fight.pkmn.stat.atk': { fr: 'Attaque', en: 'Attack' },
  'fight.pkmn.stat.def': { fr: 'Défense', en: 'Defense' },
  'fight.pkmn.stat.spc': { fr: 'Spécial', en: 'Special' },
  'fight.pkmn.stat.spe': { fr: 'Vitesse', en: 'Speed' },
  'fight.pkmn.statAbbr.atk': { fr: 'Atq', en: 'Atk' },
  'fight.pkmn.statAbbr.def': { fr: 'Déf', en: 'Def' },
  'fight.pkmn.statAbbr.spc': { fr: 'Spé', en: 'Spc' },
  'fight.pkmn.statAbbr.spe': { fr: 'Vit', en: 'Spe' },
  // Étiquettes de statut (badges) + K.O. court + ligne de stats du draft.
  'fight.pkmn.ailment.par': { fr: 'PAR', en: 'PAR' },
  'fight.pkmn.ailment.psn': { fr: 'PSN', en: 'PSN' },
  'fight.pkmn.ailment.slp': { fr: 'SOM', en: 'SLP' },
  'fight.pkmn.koShort': { fr: 'K.O.', en: 'KO' },
  'fight.pkmn.draftStats': { fr: 'PV {hp} · Atq {atk} · Déf {def} · Spé {spc} · Vit {spe}', en: 'HP {hp} · Atk {atk} · Def {def} · Spc {spc} · Spe {spe}' },
