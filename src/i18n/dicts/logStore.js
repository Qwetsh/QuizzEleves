...
export default {
  ...
  'log.store.streakGuard':       { fr: '🔥 Garde-série : {emoji} {name} conserve sa série malgré l’erreur !', en: '🔥 Streak guard: {emoji} {name} keeps the streak despite the miss!' },
  'log.store.secondChance':      { fr: '🔁 Seconde chance : {emoji} {name} rejoue la question !', en: '🔁 Second chance: {emoji} {name} replays the question!' },
  'log.store.stealItem':         { fr: '🕵️ {aemoji} {aname} vole {icon} {iname} à {vemoji} {vname} !', en: '🕵️ {aemoji} {aname} steals {icon} {iname} from {vemoji} {vname}!' },
  'log.store.stealItemFull':     { fr: '🕵️ {aemoji} {aname} vole {icon} {iname} à {vemoji} {vname} (sac plein → +{n} 🪙).', en: '🕵️ {aemoji} {aname} steals {icon} {iname} from {vemoji} {vname} (bag full → +{n} 🪙).' },
  'log.store.stealItemGold':     { fr: '🕵️ {aemoji} {aname} ne trouve aucun objet et prend {n} 🪙 à {vemoji} {vname}.', en: '🕵️ {aemoji} {aname} finds no item and takes {n} 🪙 from {vemoji} {vname}.' },
  'log.store.stealItemNone':     { fr: '🕵️ {aemoji} {aname} ne trouve rien à voler chez {vemoji} {vname}.', en: '🕵️ {aemoji} {aname} finds nothing to steal from {vemoji} {vname}.' },
  'log.store.stealItemImmune':   { fr: "🔒 {emoji} {name} est immunisé au vol d'objet : rien n'est pris !", en: '🔒 {emoji} {name} is immune to item theft: nothing taken!' },
  'log.store.interest':          { fr: '💹 Intérêts : {emoji} {name} gagne {n} 🪙.', en: '💹 Interest: {emoji} {name} earns {n} 🪙.' },
  'log.store.tithe':             { fr: '⛪ Dîme : {aemoji} {aname} prélève {n} 🪙 sur le gain de {vemoji} {vname}.', en: '⛪ Tithe: {aemoji} {aname} takes {n} 🪙 from {vemoji} {vname}’s gain.' },
  'log.store.bountyClaim':       { fr: '🎯 Prime touchée : {aemoji} {aname} empoche {n} 🪙 (erreur de {vemoji} {vname}).', en: '🎯 Bounty claimed: {aemoji} {aname} pockets {n} 🪙 ({vemoji} {vname}’s mistake).' },
  'log.store.investWin':         { fr: '📈 Investissement gagnant : {emoji} {name} récupère {n} 🪙 !', en: '📈 Investment paid off: {emoji} {name} gets {n} 🪙!' },
  'log.store.investLost':        { fr: '📉 Investissement perdu : {emoji} {name} perd sa mise de {n} 🪙.', en: '📉 Investment lost: {emoji} {name} loses the {n} 🪙 stake.' },
  'log.store.checkpointTeleport': { fr: '🚩 {emoji} {name} se téléporte sur son point de contrôle.', en: '🚩 {emoji} {name} teleports to their checkpoint.' },
